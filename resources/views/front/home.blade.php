        ...
        <form action="{{ route('cart_submit') }}" method="post">
            ...
            <div class="inner">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <input type="number" name="children" class="form-control" min="0" max="30" placeholder="Childrens">
                        </div>
                    </div>
                    <div class="col-lg-2">
            ...
            <div class="col-md-3">
                <div class="inner">
                    ...
                    <div class="text">
                        ...
                        <div class="button">
                            <a href="{{ route('room_detail',$item->id) }}" class="btn btn-primary">Readmore</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="inner">
                    ...
                    <div class="text">
                        ...
                        <div class="button">
                            <a href="{{ route('post',$item->id) }}" class="btn btn-primary">Readmore</a>
                        </div>
                    </div>
                </div>
            </div>
