                    ...
                    <div class="text-md-right">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                    <h5>Proof of payment has been sent with the order ID number#{{ $order->order_no }}</h5>
                            </div>
                            <div class="text-center">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <h5>There is no proof of payment yet</h5>
                            </div>
                        </div>
                        @endif
                        <span class="badge badge-info">
                            Payment Method Bank Transfer. Manual confirmation by admin. Please contact the admin after uploading proof of transfer</span>
                        @php
                        ...
                        <div class="form-group mt-4">
                            <label for="">Upload Proof of Payment now.</label>
