            ...
            <div class="col-md-12">
                <div class="invoice">
                    ...
                    <div class="text-md-right">
                        ...
                        <span class="badge badge-info">Midtrans Payment Method. Automatic confirmation after successful payment. Please reload this page</span>
                        ...
                        @endphp
                        <button id="midtrans-btn" class="btn btn-group-sm btn-success midtrans-btn">Pay</button>
